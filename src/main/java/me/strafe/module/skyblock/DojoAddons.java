...
//                if (SLM.instance.settingsManager.getSettingByName(this, "Control QOL").getValBoolean()) {
//                    if (entity instanceof EntitySkeleton) {
//                        if (((EntitySkeleton) entity).getSkeletonType() == 1) {
//                            if (mc.thePlayer.getDistanceToEntity(entity) <= 30) {
//                                ItemStack stack = ((EntitySkeleton) entity).getCurrentArmor(3);
//
//                                if (stack != null && stack.getDisplayName().equals("§fLeather Helmet")) {
//                                    ChatUtils.addChatMessage("HI!!!");
//                                }
//                                entity2 = entity;
//                                RotationUtils.setup(RotationUtils.getRotation(entity.getPositionVector().addVector(0.0, entity.getEyeHeight(), 0.0)), (long) 100);
//                            }
//                        }
//                    }
//                }
