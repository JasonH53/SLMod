...
public class GhostAimbot extends Module {
    ...
    public void onEnable() {
        ...
        thread=null;
        if (SLM.instance.settingsManager.getSettingByName(this, "AOTV Slot").getValDouble() == 0 ) ChatUtils.addChatMessage("SET YOUR AOTV SLOT NIGGA");
    }
    ...
    public void guiDraw(GuiScreenEvent.BackgroundDrawnEvent event) {
        if (mc.thePlayer == null || mc.theWorld == null) return;
        ChatUtils.addChatMessage("Prevented you from inv walking nigga");
        KeyBinding.setKeyBindState(mc.gameSettings.keyBindForward.getKeyCode(), false);
    }
